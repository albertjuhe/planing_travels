...
final class Version20181021183748 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO typelocation (id, title, icon, created_at, updated_at, description) VALUES (5, 'Lunch', 'fa fa-utensils', '2015-08-07 17:59:29', '2015-08-07 17:59:29', null)");
        ...
        $this->addSql("INSERT INTO typelocation (id, title, icon, created_at, updated_at, description) VALUES (8, 'Automobile', 'fa fa-car', '2015-08-07 18:00:27', '2015-08-07 18:00:27', null)");
